...
// Binary Search Tree class with DFS search
public class DFSMain {
    ...
    // Method to search for a key using Depth-First Search (named bfs but uses DFS)
    ...
    public static void main(String[] args) {
        ...
        // Test DFS search (named bfs)
        int key = 7; // Search for node with value 7
        Node result = bst.bfs(key);
        System.out.println("DFS Search for " + key + ": " +
